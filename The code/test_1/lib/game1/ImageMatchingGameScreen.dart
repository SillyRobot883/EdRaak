...
class ImageMatchingGameScreen extends StatefulWidget {
  @override
  _ImageMatchingGameScreenState createState() => _ImageMatchingGameScreenState();
}

class _ImageMatchingGameScreenState extends State<ImageMatchingGameScreen> {
  List<List<String>> levelsImages = [
    ['images/Ball.png', 'images/Ball.png', 'images/Ball.png', 'images/Ball.png'],
    ['images/Apple.png', 'images/Apple.png', 'images/Apple.png', 'images/Ball.png', 'images/Ball.png'],
    ['images/Clocks.png', 'images/Clocks.png', 'images/Apple.png'],
    ['images/Egg.png', 'images/Battery.png', 'images/Battery.png', 'images/Ball.png', 'images/Tree.png'],
  ];

  List<int> correctAnswers = [4, 3, 2, 1];
  List<String> Questions = ["كم عدد الكرات ؟", "كم عدد التفاحات ؟", "كم عدد الساعات ؟", "كم عدد البيضات ؟"];
  int currentLevel = 1;
  int score = 0;
